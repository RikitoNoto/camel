...
void useTcpTest() {
  group("TCP", () {
    test("should be communicate", () async {
      ...
      Stream<CommunicateData<Socket>> stream = camelReceive
          .listen(SocketConnectionPoint(address: "127.0.0.1", port: 15000));

      camelSend.send(
          SocketConnectionPoint(address: "127.0.0.1", port: 15000),
          Message.fromBody(
              command: CommandStub().command, body: "Hello, camel"));
